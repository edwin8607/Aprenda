class SolucionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @solucion.save
        ...
        format.json { render :show, status: :created, location: @solucion }
      else
  ...
  def update
    respond_to do |format|
      if @solucion.update(solucion_params)
        ...
        format.json { render :show, status: :ok, location: @solucion }
      else
  ...
  def destroy
    @solucion.destroy
    respond_to do |format|
      format.html { redirect_to solucions_url, notice: 'Solucion was successfully destroyed.' }
  ...
  private
    ...
    def solucion_params
      params.require(:solucion).permit(:respuesta, :questionario_id)
    end
end
