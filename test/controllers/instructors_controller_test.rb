...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { apellidos: @instructor.apellidos, centro_id: @instructor.centro_id, email: @instructor.email, genero: @instructor.genero, identificacion: @instructor.identificacion, nombre: @instructor.nombre, titulo: @instructor.titulo }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { apellidos: @instructor.apellidos, centro_id: @instructor.centro_id, email: @instructor.email, genero: @instructor.genero, identificacion: @instructor.identificacion, nombre: @instructor.nombre, titulo: @instructor.titulo }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
