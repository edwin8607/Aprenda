...
class CentrosControllerTest < ActionController::TestCase
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post :create, centro: { ciudad: @centro.ciudad, codigo: @centro.codigo, nombre_centro: @centro.nombre_centro, regional_id: @centro.regional_id }
    end
  ...
  test "should update centro" do
    patch :update, id: @centro, centro: { ciudad: @centro.ciudad, codigo: @centro.codigo, nombre_centro: @centro.nombre_centro, regional_id: @centro.regional_id }
    assert_redirected_to centro_path(assigns(:centro))
  end
